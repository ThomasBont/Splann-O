...
const translations: Record<Language, Translations> = {
  en: {
    title: "Splann-O",
    subtitle: "Plan together, split clearly",
    ...
    landing: {
      heading: "Plan together, split clearly",
      ...
      faqFreeQ: "Is it free?",
      faqFreeA: "Yes. Splann-O is free to use. Create plans, add expenses, and keep the group in sync — no hidden fees.",
      faqAccountsQ: "Do friends need accounts?",
      faqAccountsA: "For the demo, no. For the full app, friends can join with a quick sign-up to save their plans, chat, and shared history.",
      ...
      footerTagline: "Plan together, split clearly.",
      ...
      shareHook: "See how Splann-O works with your group",
    },
    welcome: {
      title: "Welcome, {name}!",
    ...
    events: {
      event: "Plan",
      newEvent: "New plan",
      noEventsYet: "No plans yet",
      noEventsSubtitle: "Start your first plan with your friends.",
      selectEvent: "Select or start a plan to get going",
    },
    eventTypes: {
      barbecue: "Barbecue",
    ...
    profileStats: { events: "Plans", friends: "Friends", totalSpent: "Total spent" },
    ...
    privateWizard: {
      stepBasics: "1/3 The plan",
      stepType: "2/3 What kind of plan?",
      stepVibe: "3/3 The vibe",
      basicsNameHint: "Give your plan a clear name to continue.",
      basicsLocationLabel: "Location",
  ...
  es: {
    title: "Splann-O",
    subtitle: "Planeen juntos, dividan claro",
    ...
    landing: {
      heading: "Planeen juntos, dividan claro",
      ...
      heroTitle: "Planeen juntos. Dividan claro.",
      ...
      faqFreeQ: "¿Es gratis?",
      faqFreeA: "Sí. Splann-O es gratis. Creá planes, agregá gastos y mantengan todo en orden — sin costos ocultos.",
      ...
      footerTagline: "Planeen juntos, dividan claro.",
      ...
      shareHook: "Mirá cómo funciona Splann-O en grupo",
    },
    welcome: {
  ...
  it: {
    title: "Splann-O",
    subtitle: "Organizzatevi insieme, dividete con chiarezza",
    ...
    landing: {
      heading: "Organizzatevi insieme, dividete con chiarezza",
      ...
      heroTitle: "Organizzatevi insieme. Dividete con chiarezza.",
      ...
      faqFreeQ: "È gratis?",
      faqFreeA: "Sì. Splann-O è gratuito. Crea piani, aggiungi spese e tieni il gruppo allineato — nessun costo nascosto.",
      ...
      footerTagline: "Organizzatevi insieme, dividete con chiarezza.",
      ...
      shareHook: "Scopri come Splann-O funziona con il gruppo",
    },
    welcome: {
  ...
  nl: {
    title: "Splann-O",
    subtitle: "Plan samen, verdeel duidelijk",
    ...
    landing: {
      heading: "Plan samen, verdeel duidelijk",
      ...
      heroTitle: "Plan samen. Verdeel duidelijk.",
      ...
      faqFreeA: "Ja. Splann-O is gratis. Maak plannen, voeg uitgaven toe en houd alles overzichtelijk — geen verborgen kosten.",
      ...
      footerTagline: "Plan samen, verdeel duidelijk.",
      footerProduct: "Product",
      ...
      shareHook: "Bekijk hoe Splann-O werkt met je groep",
    },
    welcome: {
      title: "Welkom, {name}!",
